                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="ec-vendor-block-profile">
                            <img src="{{ auth()->user()->shop && auth()->user()->shop->banner ? Storage::url(auth()->user()->shop->banner) : asset('assets/img/1.jpg') }}"
                                alt=""
                                ...
                                <div class="ec-vendor-block-detail">
                                    <div style="position: relative;">
                                        ...
                                        <img class="v-img img-fluid"
                                            src="{{ auth()->user()->shop && auth()->user()->shop->logo ? Storage::url(auth()->user()->shop->logo) : asset('assets/img/heaer.jpg') }}"
                                            alt="vendor image">
