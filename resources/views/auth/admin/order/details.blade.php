    ...
    <div class="invoice-container">
        ...
        <table class="invoice-table ">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $item->quantity }} x {{ $item->product->name }},
                        @php
                            $variation = $item->orderproduct->variation ? json_decode($item->orderproduct->variation) : null;
                        @endphp
                        @if($variation)
            ...
            ">Pending</span>
                    ...
                    <td>
                        <a href="{{ route('payout', $item) }}" OnClick='return (confirm("Are you sure you want to payment request?"));' title="Payouts"
                  ...
                  <tr>
                    ...
                    <td colspan="4"> <p class="text-primary" style="font-size: 20px">Platform Fee</p></td>
               
                    <td colspan="2"><p class="text-primary" style="font-size: 20px">{{ Sohoj::price($order->platform_fee) }}</p></td>
                </tr>
