...
<div class="col-md-3 col-sm-6 col-12 mb-4">
    <div class="product-card">
        ...
        {{-- Product Content Section --}}
            ...
            <div class="product-content" style="cursor: pointer;" onclick="window.location.href='{{ route('product_details', $product->slug) }}'">
                {{-- Product Category --}}
                ...
                @else
                    ...
                    <form action="{{ route('cart.boynow') }}" method="POST" class="add-to-cart-form">
                        ...
                        <input type="hidden" name="product_id" value="{{ $product->id }}">
                        <div class="d-grid">
                            <button class="btn btn-dark rounded-3 mt-2 " type="submit"
                                aria-label="Add {{ $product->name }} to cart">
                                <span class="spinner" style="display:none;margin-right:8px;"><i
                                        class="fas fa-spinner fa-spin"></i></span>
