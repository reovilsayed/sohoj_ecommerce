<div class="col-lg-3 col-md-4 col-sm-6 mb-4">
    <div class="card border-0 shadow-sm rounded-4 position-relative overflow-hidden product-hover-group">
        <a href="{{ route('product_details', $product->slug) }}" class="d-block">
            <img src="https://5.imimg.com/data5/SELLER/Default/2021/11/JU/IF/CF/11337912/e-commerce-product-image-editing-services.jpg" alt="{{ $product->name }}" class="card-img-top"
        ...
        <div class="card-body text-center">
            ...
            <form class="mt-2 addToCartForm_{{ $product->id }}">
                ...
                <button class="btn btn-sm w-100 px-3 cart-store" style="background-color: #CD184F; color: white" type="button"
