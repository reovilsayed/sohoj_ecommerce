...
<head>
    ...
    <title>New Contact Message - AfrikArtt</title>
    <style>
    ...
    <div class="email-container">
        ...
        <div class="email-header">
            <div class="header-content">
                <div class="logo-section">
                    <div class="logo-icon">
                        <img src="{{ Settings::setting('site_logo') }}" alt="AfrikArtt Logo" height="40">
                    </div>
                    <h1 class="company-name">AfrikArtt</h1>
        ...
        <div class="email-content">
            ...
            <div class="message-intro">
                ...
                <p class="intro-text">
                    A new message has been submitted through the AfrikArtt contact form.
            ...
            <div class="contact-details">
                <div class="details-header">
                    <div class="details-icon">
                        <!-- User Icon SVG -->
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="User Icon">
                            <circle cx="12" cy="8" r="4" fill="#fff" opacity="0.9"/>
                            <path d="M4 19c0-3.3137 3.134-6 8-6s8 2.6863 8 6v1a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-1z" fill="#fff" opacity="0.7"/>
                        </svg>
                    </div>
            ...
            <div class="message-content">
                <div class="message-header">
                    <span class="message-icon">
                        ...
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-label="Message Icon" xmlns="http://www.w3.org/2000/svg">
                            <rect x="2" y="3" width="16" height="12" rx="4" fill="#DE991B" opacity="0.15"/>
                            <rect x="2" y="3" width="16" height="12" rx="4" stroke="#DE991B" stroke-width="1.5"/>
                            <path d="M6 15v2a1 1 0 0 0 1.447.894l3.106-1.553A2 2 0 0 1 12 16h2a4 4 0 0 0 4-4V7a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v5a4 4 0 0 0 4 4h0z" fill="none"/>
        ...
        <div class="action-section">
            ...
            <a href="mailto:{{ $contactData['email'] ?? '' }}?subject=Re: Your AfrikArtt Inquiry{{ !empty($contactData['order_number']) ? ' - Order ' . $contactData['order_number'] : '' }}&body=Dear {{ $contactData['first_name'] ?? 'Valued Customer' }},%0D%0A%0D%0AThank you for contacting AfrikArtt. We have received your message and will be happy to assist you.%0D%0A%0D%0ABest regards,%0D%0AAfrikArtt Support Team"
                class="btn-primary">
                <!-- Email Icon SVG -->
                <svg width="18" height="18" viewBox="0 0 20 20" fill="none" aria-label="Email Icon" xmlns="http://www.w3.org/2000/svg" style="vertical-align:middle; margin-right:6px;">
                    <rect x="2" y="4" width="16" height="12" rx="3" fill="#ffffff" opacity="0.15"/>
                    <rect x="2" y="4" width="16" height="12" rx="3" stroke="#ffffff" stroke-width="1.5"/>
                    <path d="M4 6l6 5 6-5" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                Reply to Customer
            </a>
        </div>
        ...
        <div class="email-footer">
            <div class="footer-content">
                <h4 class="footer-title">AfrikArtt Support Team</h4>
                <p class="footer-text">
                    This email was automatically generated from the AfrikArtt contact form.
                ...
                <div class="footer-links">
                    ...
                    <a href="mailto:support@afrikartt.com" class="footer-link">Contact Admin</a>
                </div>

                <div class="footer-bottom">
                    <p>&copy; {{ date('Y') }} AfrikArtt. All rights reserved.</p>
