    ...
    <div class="email-container">
        ...
        <div class="email-header">
            <div class="logo-section">
                @if (Settings::setting('site_logo'))
                    <img src="{{ Settings::setting('site_logo') }}" alt="Afrikartt Logo" class="logo">
                @else
        ...
        <div class="email-body">
            ...
            <div class="order-summary-section">
                ...
                <div class="simple-order-info">
                    <div class="simple-info-row">
                        ...
                        <span class="simple-info-value">#{{ $order->id ?? 'AF-' . date('Ymd') . '-' . rand(1000, 9999) }}</span>
                    </div>
                    <div class="simple-info-row">
                    ...
                    <div class="simple-info-row">
                        ...
                        <span class="simple-info-value">{{ ucfirst($order->payment_method ?? 'Cash on Delivery') }}</span>
                    </div>
                    <div class="simple-info-row">
                        <span class="simple-info-label">Payment Status</span>
                        <span class="simple-status-badge">{{ ucfirst($order->payment_status == 1 ? 'Paid' : 'Pending') }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="support-section">
                ...
                <div class="support-contacts">
                    <a href="mailto:{{ $order->shop->email ?? 'support@afrikartt.com' }}" class="support-contact">
        ...
        <div class="email-footer">
            <div class="footer-content">
                <h4 class="footer-title">Afrikartt E-commerce</h4>
            ...
            <div class="footer-contact">
                ...
                <p>© {{ date('Y') }} Afrikartt E-commerce. All rights reserved.</p>
