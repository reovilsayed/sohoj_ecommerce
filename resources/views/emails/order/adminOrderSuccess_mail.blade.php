    ...
    <div class="email-container">
        ...
        <div class="email-header">
            <div class="logo-section">
                ...
                @else
                    <div style="font-size: 24px; font-weight: bold; color: white;">Afrikartt</div>
                @endif
            </div>
            ...
            <div class="order-summary">
                ...
                <div class="order-info-grid">
                    ...
                    <div class="info-card">
                        ...
                        <div class="info-value">
                            <span class="status-badge status-pending">{{ $order->status === 1 ? 'Paid' : 'Pending' }}</span>
                        </div>
                    </div>
                    <div class="info-card">
        ...
        <div class="email-footer">
            <div class="footer-content">
                <h4>Afrikartt E-commerce Admin</h4>
