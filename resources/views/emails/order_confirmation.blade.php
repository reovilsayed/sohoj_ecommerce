...
<head>
    ...
    <title>Thank You for Your Order - AfrikArtt</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="email-container">
        ...
        <div class="header">
            <div class="logo">
                ...
                <div class="logo-text">AfrikArtt</div>
            </div>
            <h1 class="header-title">Thank You for Order</h1>
            <p class="header-subtitle">Your order's in. We're working to get it packed up and out the door expect a dispatch confirmation email soon.</p>
        ...
        <div class="content">
            ...
            <div class="summary-section">
                ...
                <div class="summary-right">
                    ...
                    <div class="address-info">
                        <div class="customer-name">{{ $shipping['first_name'] ?? $order->first_name ?? 'N/A' }} {{ $shipping['last_name'] ?? $order->last_name ?? '' }}</div>
                        <div>{{ $shipping['address'] ?? 'N/A' }}</div>
                        <div>{{ $shipping['city'] ?? '' }}{{ !empty($shipping['city']) && !empty($shipping['state']) ? ', ' : '' }}{{ $shipping['state'] ?? '' }} {{ $shipping['zip'] ?? '' }}</div>
            ...
            <div class="items-section">
                ...
                @if($order->childs && $order->childs->count() > 0)
                    ...
                    <div class="item">
                        ...
                        @else
                            <div class="item-image" style="background: #f0f0f0; display: flex; align-items: center; justify-content: center; color: #999;">No Image</div>
                        @endif
                ...
                @elseif($order->product)
                    <div class="item">
                        @if($order->product->image)
                            <img src="{{ asset('storage/' . $order->product->image) }}" alt="{{ $order->product->name }}" class="item-image">
                        @else
                            <div class="item-image" style="background: #f0f0f0; display: flex; align-items: center; justify-content: center; color: #999;">No Image</div>
                        @endif
                        <div class="item-details">
            ...
            <div class="support-section">
                ...
                <div class="support-buttons">
                    <a href="mailto:help@afrikartt.com" class="support-btn">
                        📧 Email Us
                        <br><span style="font-size: 12px; font-weight: normal;">help@afrikartt.com</span>
                    </a>
            ...
            <div class="referral-section">
                ...
                <p class="referral-description">Share the link below and you'll get every friend who places an order over $60. Easy peasy.</p>
            ...
            <div class="business-section">
                ...
                <div class="business-content">
                    ...
                    <p>Feel free to reach out to us at <a href="mailto:partner@afrikartt.com" class="business-email">partner@afrikartt.com</a><br>
        ...
        <div class="footer">
            ...
            <div class="footer-address">
                AfrikArtt HQ, 123 Creative Street Unit 10<br>
                Accra, Ghana 00233
            </div>
