                        ...
                        <form class="contact-form" action="{{ route('contact.store') }}" method="POST">
                            ...
                            <div class="form-footer">
                                <div class="form-check mb-4 d-flex justify-content-center align-items-center">
                                    <input class="form-check-input" type="checkbox" id="privacy_agree"
                                        name="privacy_agree" required>
                                    <label class="form-check-label ms-2" for="privacy_agree">
                                        I agree to AfrikArtt's <a href="{{ route('privacy.policy') }}" target="_blank"
                            ...
                            <div class="email-departments">
                                <div class="email-item">
                                    ...
                                    <div class="email-content">
                                        ...
                                        <a href="mailto:{{ Settings::setting('site_email') }}">{{ Settings::setting('site_email') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
