...
@section('meta_description', 'Join Afrikart as a vendor and submit your company and products to reach customers worldwide. Complete vendor registration and product submission form.')
...
<div class="vendor-hero">
    <div class="container">
        <h1 class="display-4 fw-bold mb-3">Become a Vendor on Afrikart</h1>
        <p class="lead mb-0">Submit your company and products to reach customers worldwide</p>
    </div>
</div>
...
<main class="container my-5">
    ...
    <form id="vendorRegistrationForm" method="POST" action="{{ route('vendor.registration.store') }}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="form-section-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="company_name" class="form-label">Company/Brand Name <span class="required">*</span></label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="country" class="form-label">Country of Operation <span class="required">*</span></label>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('short_description') is-invalid @enderror" 
                              id="short_description" name="short_description" rows="4" maxlength="200" required>{{ old('short_description') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="radio-group">
                        <div class="radio-item">
                            <input type="radio" class="form-check-input" id="registered_yes" name="legally_registered" value="yes" {{ old('legally_registered') == 'yes' ? 'checked' : '' }} required>
                            <label for="registered_yes">Yes</label>
                        </div>
                        <div class="radio-item">
                            <input type="radio" class="form-check-input" id="registered_no" name="legally_registered" value="no" {{ old('legally_registered') == 'no' ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    <label for="business_registration" class="form-label">Upload Business Registration / License <span class="required">*</span></label>
                    ...
                    <input type="file" class="d-none @error('business_registration') is-invalid @enderror" 
                           id="business_registration" name="business_registration" accept=".pdf,.jpg,.jpeg,.png" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="contact_person" class="form-label">Contact Person Name <span class="required">*</span></label>
        ...
        <div class="form-section" id="step3">
            ...
            <div class="form-section-body">
                <div class="form-group">
                    <label for="packaging_method" class="form-label">Packaging Method <span class="required">*</span></label>
                    <textarea class="form-control @error('packaging_method') is-invalid @enderror" 
                              id="packaging_method" name="packaging_method" rows="4" required>{{ old('packaging_method') }}</textarea>
                ...
                <div class="form-group">
                    <label for="shipping_methods" class="form-label">Shipping Method(s) <span class="required">*</span></label>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="delivery_time" class="form-label">Estimated Delivery Time to the U.S. <span class="required">*</span></label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label">Shipment Tracking Available? <span class="required">*</span></label>
                            <div class="radio-group">
                                <div class="radio-item">
                                    <input type="radio" class="form-check-input" id="tracking_yes" name="tracking_available" value="yes" {{ old('tracking_available') == 'yes' ? 'checked' : '' }} required>
                                    <label for="tracking_yes">Yes</label>
                                </div>
                                <div class="radio-item">
                                    <input type="radio" class="form-check-input" id="tracking_no" name="tracking_available" value="no" {{ old('tracking_available') == 'no' ? 'checked' : '' }}>
                                    <label for="tracking_no">No</label>
                                </div>
                            </div>
        ...
        <div class="form-section" id="step4">
            ...
            <div class="form-section-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="brand_logo" class="form-label">Upload Brand Logo <span class="required">*</span></label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="file-upload-area" onclick="document.getElementById('promotional_material').click()">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('social_media_links') is-invalid @enderror" 
                              id="social_media_links" name="social_media_links" rows="3" 
        ...
        <div class="form-section" id="step5">
            <div class="form-section-header">
                ...
                <h3>Vendor Agreement & Policies</h3>
            </div>
            <div class="form-section-body">
                <div class="policy-section">
                    <h5>Afrikart Vendor Terms & Conditions</h5>
                    <div class="policy-text">
                        <p><strong>1. Vendor Responsibilities:</strong></p>
                        <ul>
                        ...
                        <p><strong>2. Product Standards:</strong></p>
                        <ul>
                        ...
                        <p><strong>3. Shipping & Fulfillment:</strong></p>
                        <ul>
                    ...
                    <a href="#" class="btn btn-outline-primary btn-sm" onclick="toggleFullTerms()">Read Full Terms</a>
                </div>
                ...
                <div class="form-group">
                    <label class="form-label">Can you handle customer inquiries, returns, complaints? <span class="required">*</span></label>
                    <div class="radio-group">
                        <div class="radio-item">
                            <input type="radio" class="form-check-input" id="customer_service_yes" name="customer_service" value="yes" {{ old('customer_service') == 'yes' ? 'checked' : '' }} required>
                            <label for="customer_service_yes">Yes</label>
                        </div>
                        <div class="radio-item">
                            <input type="radio" class="form-check-input" id="customer_service_no" name="customer_service" value="no" {{ old('customer_service') == 'no' ? 'checked' : '' }}>
                            <label for="customer_service_no">No</label>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <label class="form-label">Agree to maintain accurate product info and quality standards? <span class="required">*</span></label>
                    <div class="radio-group">
                        <div class="radio-item">
                            <input type="radio" class="form-check-input" id="quality_standards_yes" name="quality_standards" value="yes" {{ old('quality_standards') == 'yes' ? 'checked' : '' }} required>
                            <label for="quality_standards_yes">Yes</label>
                        </div>
                        <div class="radio-item">
                            <input type="radio" class="form-check-input" id="quality_standards_no" name="quality_standards" value="no" {{ old('quality_standards') == 'no' ? 'checked' : '' }}>
                            <label for="quality_standards_no">No</label>
                        </div>
                    </div>
        ...
        <div class="submit-section">
            ...
            <p class="text-muted mb-4">Review all information before submitting. You can save and continue later if needed.</p>
