            ...
            <div class="form-section" id="step5">
                ...
                <div class="form-section-body">
                    <div class="policy-section">
                        ...
                        <a href="#" class="btn btn-outline-primary btn-sm" onclick="toggleFullTerms()">Read Full
                            Terms</a>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-group">
                            <div class="radio-item">
                                <input type="radio" class="form-check-input" id="customer_service_yes"
                                    name="customer_service" value="yes"
                                    {{ old('customer_service') == 'yes' ? 'checked' : '' }} required>
                                <label for="customer_service_yes" class="form-check-label mb-0">Yes</label>
                            </div>
                            <div class="radio-item">
                                <input type="radio" class="form-check-input" id="customer_service_no"
                                    name="customer_service" value="no"
                                    {{ old('customer_service') == 'no' ? 'checked' : '' }}>
