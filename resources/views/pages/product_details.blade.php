                                    ...
                                    <div class="card shadow-sm border-0 rounded-4 overflow-hidden position-relative h-100">
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <div class="text-muted small mb-1">
                                                {{ Str::limit(strip_tags($product->short_description), 40) }}</div>
                                            <div class="mb-2">
                                                <span
                                                    class="text-danger fw-bold">{{ Sohoj::price($product->sale_price ?? $product->price) }}</span>
                                                @if ($product->sale_price)
                                                    <span
                                            ...
                                            <form class="addToCartForm_{{ $product->id }}">
                                                ...
                                                <button class="btn btn-sm btn-dark w-100" data-product-id="{{ $product->id }}" type="button"
