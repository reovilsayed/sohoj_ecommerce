<x-filament::page>
    ...
    <div id="body" class="bg-gray-50 font-sans text-gray-700 print:bg-white">
        <div class="max-w-4xl mx-auto my-8 print:my-0">
            <!-- Invoice Container -->
            <div
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm font-medium">
                                ...
                                @elseif($order->status == 2)
                                    <span class="px-2 py-1 rounded-full bg-purple-100 text-purple-800">Shipped</span>
                                ...
                                @elseif($order->status == 5)
                                    <span class="px-2 py-1 rounded-full bg-orange-100 text-orange-800">Refund
                                        Request</span>
                                @endif
                            </p>
                        </div>
                            ...
                            <div class="pt-3">
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-base font-semibold text-primary-600">
                                        {{ Sohoj::price($record->vendor_total + $record->shipping_total) }}
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="p-6 bg-gray-50 rounded-lg no-print">
                    ...
                    <div class="flex flex-wrap justify-center gap-4">
                        ...
                        @endif
                        @if ($order->status == 3)
                            <span class="px-4 py-2 text-white rounded-md" style="background-color: rgb(152, 12, 12)">
                                Order Canceled
                            </span>
                        @endif
                        ...
                        @if ($order->status == 1 || $order->status == 2)
                            <button onclick="toggleTrackingInput()"
                                class="px-4 py-2 text-white font-medium rounded-md" style="background-color: #0077B6">
                                Add Tracking Info
                            </button>
                        @endif
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label for="shipping_method"
                                        class="block text-sm font-medium text-gray-700 mb-1">Shipping Carrier</label>
                                ...
                                <div>
                                    <label for="trackingUrlInput"
                                        class="block text-sm font-medium text-gray-700 mb-1">Tracking Number</label>
                    ...
                    @if ($order->shipping_url)
                        <div class="mt-6 pt-6 border-t border-gray-200 flex justify-center gap-3 items-center">
                            ...
                            <a href="{{ route('vendor.invoice', $order) }}"
                                class="px-3 py-1.5 text-white text-sm rounded" style="background-color: #209EBB">Order
                                Details
                            </a>
                        </div>
                    @endif
                ...
                <div class="p-6 bg-gray-50 rounded-lg">
                    <h3 class="text-sm font-semibold text-gray-700 uppercase tracking-wider mb-4">Payment Information
                    </h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-white p-4 rounded-lg border border-gray-200">
                            ...
                            <div class="space-y-1 text-sm text-gray-600">
                                ...
                                <p>Account Name: {{ $record->shop->name }}</p>
                ...
                <div class="px-8 py-4 bg-white border-t border-gray-200 rounded-b-lg no-print">
                    <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                        ...
                        <div class="flex flex-wrap gap-3">
                            ...
                            <a href="#"
                                icon="heroicon-o-arrow-down-tray" class="w-full md:w-auto py-2 px-4 text-center rounded-md"
    ...
    @push('scripts')
        <script>
            ...
            function toggleTrackingInput() {
                const container = document.getElementById('trackingInputContainer');
